  ...
  return `
    <div class="floating-widgets">
      <div class="chatbot-widget">
        ...
        <svg class="chatbot-arrow" viewBox="0 0 88 78" width="88" height="78" aria-hidden="true" focusable="false">
          <defs>
            <marker id="chatbot-arrowhead" markerWidth="18" markerHeight="13" refX="1" refY="6.5" orient="auto" markerUnits="userSpaceOnUse">
              <polygon points="0,0 17,6.5 0,13" fill="currentColor"/>
            </marker>
          </defs>
          <circle cx="16" cy="16" r="3" fill="currentColor"/>
          <path d="M 16,16 C 46,2 72,22 52,54"
                stroke="currentColor"
                stroke-width="6"
                fill="none"
                stroke-linecap="butt"
                marker-end="url(#chatbot-arrowhead)"/>
        </svg>
      </div>
    </div>
    ...
    <div class="chat-window" id="chat-window" aria-hidden="true">
      <div class="chat-window__header">
        <h3>Michael Blake, Your Housing AI Assistant</h3>
      ...
      <div class="chat-window__wa-banner">
        <a href="https://wa.me/27123456789" target="_blank" rel="noopener">
          ...
          Speak with Michael Blake on WhatsApp!
        </a>
      </div>
      <div class="chat-window__body">
        <p class="chat-msg">My name is Michael Blake, an A.I Chatbot for Housing Assembly! Ask me anything and I'll do my best to help!</p>
      </div>
