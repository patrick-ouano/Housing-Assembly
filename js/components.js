...
function renderChatbot() {
  return `
    <div class="floating-widgets">
      <button class="widget-btn widget-btn--chatbot" id="chatbot-toggle" aria-label="Chat with Blake" aria-controls="chat-window" aria-expanded="false">
        <span class="widget-btn__icon" aria-hidden="true">
        ...
        <span class="widget-btn__label">Chat with Blake</span>
      </button>
    </div>
    ...
    <div class="chat-window" id="chat-window" aria-hidden="true">
      ...
      <div class="chat-window__wa-banner">
        <a href="https://wa.me/27612611311" target="_blank" rel="noopener">
